...
AUTHORS_FILE="/home/sudar/Dropbox/code/wp/wp-plugin-in-gitbub/authors.txt"
SVN_USERNAME="sudar"
...
git svn clone -s -A $AUTHORS_FILE --no-minimize-url --username=$SVN_USERNAME http://plugins.svn.wordpress.org/$PLUGIN_NAME -$REVISION
